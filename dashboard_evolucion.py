...
with col_izq:
    ...
    # CORRECCIÓN AQUÍ: Agregamos .reset_index() para que 'Mes' sea una columna real y legible para el eje X
    ...
    resumen_mensual.plot(x='Mes', kind='bar', color=['#4B5563', '#0284C7'], ax=ax, width=0.35)
    ...
    plt.xticks(rotation=0) # Evita que los nombres de los meses salgan torcidos
